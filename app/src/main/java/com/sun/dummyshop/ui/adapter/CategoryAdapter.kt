...
class CategoryAdapter(
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        val randomColors = holder.itemView.context.resources.getIntArray(R.array.random_colors)
        val randomColor = randomColors[Random().nextInt(randomColors.size)]
        holder.itemView.layoutCategory.background.colorFilter =
